...
const AsideSvg = (props) => (
    ...
    <div className="aboutMeTextContainer">
            <h4>
            Hello! I am a Junior Fullstack Developer and very passionate about web development! I am always looking for new things to learn, in my free time as well as at school/work. Thus far I have a high school diploma in IT and am also about to graduate my fourth extra IT year!<br/> Certificates: HTML/CSS basics, Javascript basics
            </h4>
    </div>
    </>
